...
${naming.names.map((n) => `NAME: ${n.name}
TYPE: ${n.type}
...
function buildEmail(a: Answers, briefUrl: string, naming: NamingResult | null): string {
  ...
  <div class="section">
    ...
    <div class="field-val" style="font-style:italic;margin-bottom:16px;">${naming.brandCharacter}</div>
    ${naming.names.map((n) => `
...
export async function POST(req: NextRequest) {
  try {
    ...
    const project: ProjectState = naming
      ? { ...DEFAULT_PROJECT, status: 'generated', brandCharacter: naming.brandCharacter, names: naming.names }
      : DEFAULT_PROJECT
